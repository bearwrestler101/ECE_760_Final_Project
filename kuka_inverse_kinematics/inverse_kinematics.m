...
% Devuelve las 8 soluciones
    ...
    for u=1:2       % q4
        ...
        T25 = Robot.A([3 4 5], [0 0 q3 q4(u) 0 0 0]).T;
        ...
        for v=1:2       % q2
            T15 = Robot.links(2).A(q2(v)).T*T25;     % T15 = T12*T25
            ...
            T04_actual_q1_1 = Robot.A([1 2 3 4 5], [q1(1), q2(v), q3, q4(u), 0, 0, 0]).T;
            T04_actual_q1_2 = Robot.A([1 2 3 4 5], [q1(2), q2(v), q3, q4(u), 0, 0, 0]).T;
