classdef RobotDynamics < handle
    ...
    methods
        function robot = RobotDynamics(rtbRobot)
            ...
            robot.q_t = [theta1(t) theta2(t) theta3(t) theta4(t) theta5(t) theta6(t) theta7(t)];
            robot.dq_t = [theta_dot_1(t) theta_dot_2(t) theta_dot_3(t) theta_dot_4(t) theta_dot_5(t) theta_dot_6(t) theta_dot_7(t)];
            robot.ddq_t = [theta_ddot_1(t) theta_ddot_2(t) theta_ddot_3(t) theta_ddot_4(t) theta_ddot_5(t) theta_ddot_6(t) theta_ddot_7(t)];
        ...
        function [posCOM, velCOM, w] = calculateGeometry(robot)
            ...
            for num=1:robot.n
                disp(strcat("calculating geometry for link ", num2str(num)))
%                 T0n = simplify(robot.rtbRobot.A(1:num, robot.q_t).T);
                T0n = robot.rtbRobot.A(1:num, robot.q_t).T;
